...
<head>
    ...
    <title>${product.name} - Laptop Shop</title>
    <!-- Google Web Fonts -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="/add-product-from-view-detail" method="post" modelAttribute="product">
                            ...
                            <input type="text" class="form-control d-none" value="${product.id}" name="id">
                            <input type="text" class="form-control d-none" name = "quantity" id="cartDetails0.quantity">
