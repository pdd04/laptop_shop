                ...
                <tr>
                    ...
                    <td>
                        <p class="mb-0 mt-4" data-cart-detail-id = "${cartDetail.id}">
                            <fmt:formatNumber type="number" value="${cartDetail.product.price * cartDetail.quantity}"/> đ
                        </p>
                    </td>
                    <td>
                    ...
                    <c:set var="total" value="${total + cartDetail.product.price*cartDetail.quantity}" scope="page"/>
                </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="mt-5 row g-4 justify-content-start">
            <div class="col-12 col-md-8">
                <div class="bg-light rounded">
                    ...
                    <form:form action="/comfirm-checkout" method="post" modelAttribute="cart">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                        ...
                        <button class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4" type="submit">Xác nhận đơn hàng</button>
                    </form:form>
                </div>
            </div>
        </div>
